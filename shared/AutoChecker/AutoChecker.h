...
#include "../../arc_src/arc_cache.h"
#include "../../frc_src/frc_cache.h"
 ...
 *
 * also it can check FrcCache - then it should be called by checkInputFrc.
 ...
 *
 * RES_FRC_T1_WRONG_SIZE - if |T1| > p - for only FRC
 * RES_FRC_T2_WRONG_SIZE - if |T2| > c - p - for only FRC
 * RES_FRC_L_WRONG_SIZE - if |L1| > c or |L2| > c - for only FRC
 * */
...
typedef enum {
    ...
    RES_FRC_T1_WRONG_SIZE,
    RES_FRC_T2_WRONG_SIZE,
    RES_FRC_L_WRONG_SIZE,
} CheckResult;
